...
void save(void){
  ...
  fp=fopen("data2","rb+");
  fseek(fp,(LoadPos-1)*2,0);
  fwrite(Load+LoadPos-1,sizeof(int),1,fp);
  fclose(fp);
  fp=fopen("data3","rb+");
  fseek(fp,486*(LoadPos-1),0);
  for(i=0;i<3;i++)
    for(j=0;j<9;j++)
      for(k=0;k<9;k++)
...
void state_6(int flag){
  ...
  while(1){
    ...
    case 561:if(NumList[1][PosY-1][PosX-1]==0)NumList[2][PosY-1][PosX-1]=1;break;
    case 818:if(NumList[1][PosY-1][PosX-1]==0)NumList[2][PosY-1][PosX-1]=2;break;
    case 1075:if(NumList[1][PosY-1][PosX-1]==0)NumList[2][PosY-1][PosX-1]=3;break;
    case 1332:if(NumList[1][PosY-1][PosX-1]==0)NumList[2][PosY-1][PosX-1]=4;break;
    case 1589:if(NumList[1][PosY-1][PosX-1]==0)NumList[2][PosY-1][PosX-1]=5;break;
    case 1846:if(NumList[1][PosY-1][PosX-1]==0)NumList[2][PosY-1][PosX-1]=6;break;
    case 2103:if(NumList[1][PosY-1][PosX-1]==0)NumList[2][PosY-1][PosX-1]=7;break;
    case 2360:if(NumList[1][PosY-1][PosX-1]==0)NumList[2][PosY-1][PosX-1]=8;break;
    case 2617:if(NumList[1][PosY-1][PosX-1]==0)NumList[2][PosY-1][PosX-1]=9;break;
    case 2864:if(NumList[1][PosY-1][PosX-1]==0)NumList[2][PosY-1][PosX-1]=0;break;
